...
public class UtilityVehicleServiceImpl implements UtilityVehicleService{
    ...
    @Override
    public UtilityVehicleResponseDto findByIdUtilityVehicle(UtilityVehicleRequestDto utilityVehicleRequestDto) {
        return null;
    }
    ...
    @Override
    public UtilityVehicleResponseDto deleteById(UtilityVehicleRequestDto utilityVehicleRequestDto) {
        return null;
    }
}
